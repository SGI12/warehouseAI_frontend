...
const PencilIcon = () => {
    return (
        <svg style={{cursor: 'pointer', marginLeft: '20px'}} fill="#ffffff" width="40px" height="40px" viewBox="0 0 24 24" version="1.2" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg">
